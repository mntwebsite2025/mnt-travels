...
export const sendTestEmail = async (smtpConfig, testEmailData) => {
  try {
    ...
    const mailOptions = {
      ...
      subject: 'SMTP Test Email - mnt Tours & Travels',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p style="color: #6b7280; font-size: 14px;">
            This is a test email sent from mnt Tours & Travels admin panel to verify SMTP configuration.
          </p>
          <hr style="border: none; border-top: 1px solid #e5e7eb; margin: 20px 0;">
          <p style="color: #9ca3af; font-size: 12px;">
            Sent at: ${new Date().toLocaleString()}<br>
            From: mnt Tours & Travels Admin Panel
          </p>
        </div>
      `
    };
