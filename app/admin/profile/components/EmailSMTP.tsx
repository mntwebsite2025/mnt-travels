...
export default function EmailSMTP() {
  ...
  const [emailSettings, setEmailSettings] = useState<EmailSettings>({
    ...
    smtpPassword: "",
    fromEmail: "",
    fromName: "mnt Tours & Travels",
  });

  const [testEmailData, setTestEmailData] = useState<TestEmailData>({
    email: "",
    message:
      "Greetings from mnt Tours & Travels! This is a test email to verify our SMTP configuration is working correctly for sending travel booking confirmations and updates.",
  });
